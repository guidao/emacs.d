...
")
 ...
 '(package-selected-packages
   '(ox-gfm lsp-pyright ob-ein counsel-dash emacro paredit better-jumper meow boon good-scroll iscroll shrface dot-mode datetime datetime-format elisp-format amx flx spaceline-all-the-icons all-the-icons-ivy gnu-elpa-keyring-update lsp-mode ivy-rich ivy-posframe epc xwwp-follow-link-ivy keyfreq ivy-prescient company-restclient know-your-http-well restclient expand-region thing-edit crux aweshell multiple-cursors evil-mc posframe web-beautify anzu rjsx-mode helm-org org-ql ov org-super-agenda ts counsel-projectile kubernetes-evil kubernetes nlinum quelpa-use-package quelpa company-math org-roam gkroam tao-theme ctable org-bullets htmlize ox-reveal ox-ioslide sis ob-go org-modules pdf-tools helm-rg go-playground vterm evil-org web-mode helm-dash evil-smartparens w3m lispyville lua-mode org-download php-mode elpy python-mode function-args semantic-directory protobuf-mode cargo smartparens smartparens-config company-go deft eyebrowse avy auto-complete hl-todo lsp-haskell json-mode helm-projectile elfeed idris-mode emms emms-setup lsp-ui doom-modeline helm-swoop gotest gotest\.el go-guru exec-path-from-shell go-mode helm helm-ebdb))
